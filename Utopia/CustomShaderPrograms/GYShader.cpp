...
GYShader::GYShader()
{
	std::string vertexShaderFileName = "./Resources/Shaders/GYVertexShader.glsl";
	std::string fragmentShaderFileName = "./Resources/Shaders/GYFragmentShader.glsl";
...
void GYShader::Update(const Transform & transform, const Camera & camera, SpotLight & spotLight)
{
	Bind();
